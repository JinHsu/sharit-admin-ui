<template>
    <a-select :value="value"
        ...
        <a-select-option v-if="town" :key="town.id" :value="town.id">
            {{town.name}}
        </a-select-option>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onTownClick(town) {
                if (!this.town || this.town.id !== town.id) {
                    this.onChange(town.id)
                } else {
                    this.onSelect(town.id)
                }
                this.town = town
                this.open = false
            },
            ...
            async fetchTown() {
                if (this.value) {
                    this.town = await townService.fetchOne(this.value)
                    if (this.town) {
